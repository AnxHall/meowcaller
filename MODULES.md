...
| 02 | group_call_state | `go.mau.fi/whatsmeow` | group_update_ingest | [voip-group-call-state.md](datasheets/voip-group-call-state.md) | immutable capture corpus | `group_call_state_corpus.json` | verified (`5a6350b`; apply and routing KATs pass) |
