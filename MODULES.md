...
| 02 | group_call_state | `go.mau.fi/whatsmeow` | group_update_ingest | [voip-group-call-state.md](datasheets/voip-group-call-state.md) | immutable capture corpus | `group_call_state_corpus.json` | partial (`63dc174`; snapshot apply verified, routing scaffolded) |
