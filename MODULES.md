...
| 03 | group_invite_offer | `go.mau.fi/whatsmeow/voip` | existing stanza helpers, group call types | [voip-group-invite-offer.md](datasheets/voip-group-invite-offer.md) | immutable capture corpus | `group_invite_offer_corpus.json` | planned |
